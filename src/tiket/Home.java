...
//        Memanggil Data Kelas
    ...
    private void initComponents() {
        ...
        stasiun_tujuan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Rantau Prapat (RAP)", "Tanjung Balai (TNB)", "Kertapati (KPT)", "Baturaja (BTA)", "Lubuklinggau (LLG)" }));
        ...
        ckereta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kereta", "Sindang Marga", "Putri Deli", "Siantar Ekspres" }));
        ...
        fbayar.setBackground(new java.awt.Color(255, 255, 204));
        ...
        cgerbong.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Gerbong", "Eksekutif 1", "Eksekutif 2", "Ekonomi 1", "Ekonomi 2", "Ekonomi 3" }));
        ...
        stasiun_awal.setText("Medan (MDN)");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(falamat, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void ckeretaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ckeretaActionPerformed
        ...
        if(ckereta.getSelectedItem().equals("Sindang Marga")){
        bayangan4.setValue(1);
        ckereta.setSelectedIndex(1);
       }else if(ckereta.getSelectedItem().equals("Putri Deli")){
       bayangan4.setValue(2);
       ckereta.setSelectedIndex(2);
       }
       else if(ckereta.getSelectedItem().equals("Siantar Ekspres")){
       bayangan4.setValue(3);
       ckereta.setSelectedIndex(3);
       }
       
       if(ckereta.getSelectedItem().equals("Sindang Marga") && stasiun_tujuan.getSelectedItem().equals("Rantau Prapat (RAP)")){
            berangkat.setText("08.00 WIB");
            tiba.setText("19.50 WIB");
        }else if(ckereta.getSelectedItem().equals("Sindang Marga") && stasiun_tujuan.getSelectedItem().equals("Tanjung Balai (TNB)")){
            berangkat.setText("06.00 WIB");
            tiba.setText("09.30 WIB");
        }else if(ckereta.getSelectedItem().equals("Sindang Marga") && stasiun_tujuan.getSelectedItem().equals("Kertapati (KTP))")){
            berangkat.setText("06.50 WIB");
            tiba.setText("15.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Sindang Marga") && stasiun_tujuan.getSelectedItem().equals("Baturaja (BTA))")){
            berangkat.setText("05.45 WIB");
            tiba.setText("13.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Sindang Marga") && stasiun_tujuan.getSelectedItem().equals("Lubuklinggau (LLG))")){
            berangkat.setText("08.40 WIB");
            tiba.setText("12.37 WIB");
            
            //Putri Deli
        }else if(ckereta.getSelectedItem().equals("Putri Deli") && stasiun_tujuan.getSelectedItem().equals("Rantau Prapat (RAP)")){
            berangkat.setText("07.00 WIB");
            tiba.setText("18.50 WIB");
        }else if(ckereta.getSelectedItem().equals("Putri Deli") && stasiun_tujuan.getSelectedItem().equals("Tanjung Balai (TNB)")){
            berangkat.setText("08.00 WIB");
            tiba.setText("11.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Putri Deli") && stasiun_tujuan.getSelectedItem().equals("Kertapati (KTP))")){
            berangkat.setText("08.50 WIB");
            tiba.setText("17.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Putri Deli") && stasiun_tujuan.getSelectedItem().equals("Baturaja (BTA))")){
            berangkat.setText("07.45 WIB");
            tiba.setText("15.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Putri Deli") && stasiun_tujuan.getSelectedItem().equals("Lubuklinggau (LLG))")){
            berangkat.setText("09.40 WIB");
            tiba.setText("13.37 WIB");
            
            //Siantar Ekspres
        }else if(ckereta.getSelectedItem().equals("Siantar Ekspres") && stasiun_tujuan.getSelectedItem().equals("Rantau Prapat (RAP)")){
            berangkat.setText("07.45 WIB");
            tiba.setText("19.35 WIB");
        }else if(ckereta.getSelectedItem().equals("Siantar Ekspres") && stasiun_tujuan.getSelectedItem().equals("Tanjung Balai (TNB)")){
            berangkat.setText("10.00 WIB");
            tiba.setText("14.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Siantar Ekspres") && stasiun_tujuan.getSelectedItem().equals("Kertapati (KTP))")){
            berangkat.setText("06.50 WIB");
            tiba.setText("13.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Siantar Ekspres") && stasiun_tujuan.getSelectedItem().equals("Baturaja (BTA))")){
            berangkat.setText("06.45 WIB");
            tiba.setText("14.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Siantar Ekspres") && stasiun_tujuan.getSelectedItem().equals("Lubuklinggau (LLG))")){
            berangkat.setText("08.40 WIB");
            tiba.setText("12.37 WIB");
        }
